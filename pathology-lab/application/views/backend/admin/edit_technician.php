...
<div class="row">
    <div class="col-md-12">
        ...
        <?php echo form_open(base_url() . 'admin/technician/update/'.$technician_id, array('class' => 'form-horizontal form-groups-bordered validate')); ?>

        <?php
        $technician = $this->crud_model->get_db('technician', ['technician_id' => $technician_id]);
